...
# ⚡ Bolt Optimization: Initialize heavy resources globally
# Pre-compile regex and load stopwords once at startup to avoid
# repeated compilation and I/O during request processing.
